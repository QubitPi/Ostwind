 ...
 */
package io.github.qubitpi.ostwind.metastore.graphql;

import static io.github.qubitpi.ostwind.config.ErrorMessageFormat.EMPTY_LIST;

import io.github.qubitpi.ostwind.metadata.MetaData;
import io.github.qubitpi.ostwind.metastore.MetaStore;
import io.github.qubitpi.ostwind.metastore.graphql.query.GraphQLQueryProvider;
import io.github.qubitpi.ostwind.metastore.graphql.query.GraphQLQueryProviderFactory;
 ...
 * <p>
 * {@link GraphQLMetaStore} is basically the Ostwind's implementation of GraphQL server API.
 */
@Singleton
@NotThreadSafe
