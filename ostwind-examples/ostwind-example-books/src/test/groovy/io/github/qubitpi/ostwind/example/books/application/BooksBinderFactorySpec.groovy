...
class BooksBinderFactorySpec extends Specification {
    ...
    def "When #providerClass is specified, #dbType DataSource provider is instantiated"() {
        ...
        SYSTEM_CONFIG.setProperty('ostwind__data_source_provider', providerClass)
    ...
    def "When a DataSource Provider classpath config value is not found, runtime error occurs"() {
        ...
        SYSTEM_CONFIG.clearProperty("ostwind__data_source_provider")
    ...
    def getTestIterationData() {
        [
                ['io.github.qubitpi.ostwind.example.books.application.BooksBinderFactory$DerbyDataSourceProvider', "Derby"],
                ['io.github.qubitpi.ostwind.example.books.application.BooksBinderFactory$MySQLDataSourceProvider', "MySQL"]
        ]
    }
}
