 ...
 */
package io.github.qubitpi.ostwind.example.books.application;

import static io.github.qubitpi.ostwind.config.ErrorMessageFormat.CONFIG_NOT_FOUND;

import io.github.qubitpi.ostwind.application.AbstractBinderFactory;
...
import io.github.qubitpi.ostwind.filestore.swift.SwiftFileStore;
import io.github.qubitpi.ostwind.metadata.MetaData;
import io.github.qubitpi.ostwind.metastore.MetaStore;
import io.github.qubitpi.ostwind.metastore.graphql.GraphQLMetaStore;
...
public class BooksBinderFactory extends AbstractBinderFactory {
    ...
    public static class DerbyDataSourceProvider implements Provider<DataSource> {
        ...
        private static DataSource initDataSource() {
            ...
            basicDataSource.setUrl("jdbc:derby:memory:Ostwind;create=true");
    ...
    public static class MySQLDataSourceProvider implements Provider<DataSource> {
        ...
        private static DataSource initDataSource() {
            ...
            poolDataSource.setUrl("jdbc:mysql://db:3306/Ostwind?autoReconnect=true&useSSL=false");
    ...
    /**
     * Spins up a JDBC DataSource factory instance using the ostwind-example-books configs.
     *
