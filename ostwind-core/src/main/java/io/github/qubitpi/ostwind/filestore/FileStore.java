...
/**
 * {@link FileStore} is an abstraction layer between Ostwind application and object storage; it can persist an
...
public interface FileStore {
     ...
     *
     * @return the file ID that can be used later to retrieve that file in Ostwind
     *
