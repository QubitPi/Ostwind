 ...
 */
package io.github.qubitpi.ostwind.metadata;

import static io.github.qubitpi.ostwind.config.ErrorMessageFormat.MISSING_MAP_KEY;
...
public class MetaData {
    ...
    /**
     * Given a form-data content disposition header from a file upload request, constructs an ostwind representation
    ...
    /**
     * Given a GraphQL query result, constructs an ostwind representation of a file metadata contained in that result.
     *
    ...
    /**
     * Given a set of key-value pairs, constructs an ostwind representation of a file metadata whose states are based on
