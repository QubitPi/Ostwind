...
class MetaDataSpec extends Specification {
    ...
    def "HTTP header info, in happy path, can be used to construct an equivalent Ostwind meta data object"() {
    ...
    def "Native GraphQL ExecutionResult, in happy path, can be converted to an equivalent Ostwind meta data object"() {
