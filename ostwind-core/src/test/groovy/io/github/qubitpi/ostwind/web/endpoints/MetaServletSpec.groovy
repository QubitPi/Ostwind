 ...
 */
package io.github.qubitpi.ostwind.web.endpoints


import io.github.qubitpi.ostwind.web.graphql.JsonDocumentParser
import groovy.json.JsonSlurper
import io.github.qubitpi.ostwind.application.ApplicationState
import io.github.qubitpi.ostwind.application.JerseyTestBinder
import io.github.qubitpi.ostwind.metadata.FileType
...
class MetaServletSpec extends Specification {
    ...
    def "Reading file meta data through POST cannot have field list empty"() {
        ...
        exception.message == "Ostwind could not process the request because no metadata field was found: '$graphQLDocument'"
    }
